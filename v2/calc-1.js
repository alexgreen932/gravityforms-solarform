...
class solarCalc {
    ...
    doCalculation() {
        ...
        console.log('ANGLE: ', this.#calcs.roofAngleMod);
        ...
        console.log('this.#calcs.converterCosts: ', this.#calcs.converterCosts);
        this.#calcs.batteryCosts = this.selectInRange(this.#calcs.power, this.batteryCostsTable);
        console.log('this.#calcs.batteryCosts: ', this.#calcs.batteryCosts);
        ...
        console.log('this.#calcs.totalCostsMax: ', this.#calcs.totalCostsMax);
