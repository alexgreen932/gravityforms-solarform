export default {
  ...
  calc() {
    ...
    // Retrieve values from the Vue data
    //simplified
    // const roofArea = this.roof_area;
    // const roofType = this.roof_type;
    // const roofAngle = this.roof_angle;
    //using array
    ...
    const totalCosts =
      modulesCosts + montageCosts + converterCosts + batteryCosts;
